...
const UserLogin = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link to={'/captain-login'} className='bg-[#018d5c] flex items-center justify-center mb-5 text-white font-semibol rounded px-2 py-2 w-full text-lg placeholder:text-sm'>Sign in as Captain</Link>
      </div>
    </div>
  )
}
